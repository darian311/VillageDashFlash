...
//	import com.google.analytics.GATracker;
	...
	public class Main extends Sprite 
	{
		...
		public static var spreadsheetResultSet:SpreadsheetResultSet;
		...
		public function Main():void 
		{
			...
			spreadsheetResultSet = new SpreadsheetResultSet("gamesettings@villagethegame.com", "#333edc3", "0AuzdryEj60U_dERxYjlGd1lJNkRRV1g4cnBhTTdUanc", parseCompleted); 
		...
		{  
			// use this to override values in AllSettings.
			//var temp:* = resultset[0]; 
			var SpreadSettings:Object= {};

			// AllSettings.levels[1].win_condition = resultset.getProperty("levels[1].win_condition"); 
			while(resultset.hasNext()) {
				var nextVal:* = resultset.next();
				SpreadSettings[nextVal['key']] = nextVal['value'];
				trace(nextVal['key'], nextVal['value']); 
			}
			
			currentSetting["win_condition"] = SpreadSettings["levels[1].win_condition"];
			currentSetting["innovation_name"] = SpreadSettings["levels[1].innovation_name"];
